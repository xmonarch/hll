...
LOG_HIGHLIGHTERS: List[Highlighter] = [
    ...
    Highlighter(re.compile('unsuccessfull', re.IGNORECASE)),
    Highlighter(re.compile('disconnected', re.IGNORECASE)),
    Highlighter(re.compile('successfully', re.IGNORECASE), positive=True),
    Highlighter(re.compile('uninstalling', re.IGNORECASE)),
    Highlighter(re.compile('successfull', re.IGNORECASE), positive=True),
    ...
    Highlighter(re.compile('fatal', re.IGNORECASE), raise_level=logging.CRITICAL),
    Highlighter(re.compile('error', re.IGNORECASE), raise_level=logging.ERROR),
    Highlighter(re.compile('debug', re.IGNORECASE), positive=True, raise_level=logging.DEBUG),
